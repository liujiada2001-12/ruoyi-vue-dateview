<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="上传者" prop="upBy">
        <el-input
          v-model="queryParams.upBy"
          placeholder="请输入上传者"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="msgList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="状态" align="center" prop="statusName">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.device_msg_status" :value="scope.row.statusName"/>
        </template>
      </el-table-column>
      ...
      <el-table-column label="上传者" align="center" prop="upBy" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="类别" prop="categoryName">
          <el-input v-model="form.categoryName" placeholder="请输入类别" />
        </el-form-item>
        <el-form-item label="名称" prop="name">
          <el-input v-model="form.name" placeholder="请输入名称" />
        </el-form-item>
        <el-form-item label="状态" prop="statusName">
          <el-input v-model="form.statusName" placeholder="请输入状态" />
        </el-form-item>
        <el-form-item label="上传时间" prop="upTime">
          <el-date-picker clearable
            v-model="form.upTime"
        ...
        <el-form-item label="上传者" prop="upBy">
          <el-input v-model="form.upBy" placeholder="请输入上传者" />
        </el-form-item>
...
<script>
import { listMsg, getMsg, delMsg, addMsg, updateMsg } from "@/api/device/msg";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('device/msg/export', {
        ...this.queryParams
