...
<!--        </template>-->
<!--      </el-table-column>-->
<!--      <el-table-column label="更新者" align="center" prop="upBy" />-->
...
<!--          </el-date-picker>-->
<!--        </el-form-item>-->
<!--        <el-form-item label="更新者" prop="upBy">-->
<!--          <el-input v-model="form.upBy" placeholder="请输入更新者" />-->
<!--        </el-form-item>-->
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除设备分类编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('device/category/export', {
        ...this.queryParams
